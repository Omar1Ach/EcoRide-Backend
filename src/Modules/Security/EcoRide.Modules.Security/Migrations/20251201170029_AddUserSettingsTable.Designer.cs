...
namespace EcoRide.Modules.Security.Migrations
{
    ...
    [Migration("20251201170029_AddUserSettingsTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EcoRide.Modules.Security.Domain.Entities.PaymentMethodEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.ToTable("payment_methods", "security");
                });

            modelBuilder.Entity("EcoRide.Modules.Security.Domain.Entities.UserSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.ToTable("user_settings", "security");
                });

            modelBuilder.Entity("EcoRide.Modules.Security.Domain.Entities.WalletTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.ToTable("wallet_transactions", "security");
                });
